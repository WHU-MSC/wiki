...
本文内容转载自传世名篇《提问的智慧》，你将时常在各种技术论坛中发现指向该文章的链接。

其中的部分要求可能对初学者而言会有些严苛，或许是由于原作者对于糟糕问题泛滥成灾的现象实在是忍无可忍。

该文章用于自勉，不建议强加于他人（当然你可以选择拒绝回答那些糟糕的提问，也可以出于好意扔给对方这篇文章的链接）。

严格要求自己、规范地提问当然是好事，但是不建议因为没有达成本文中的那些要求而放弃寻求帮助。
大家都是同学，互帮互助是常有的事情，随意一些完全是正常现象。

建议在群聊或者其他公开论坛中提问而非私聊或私信，
